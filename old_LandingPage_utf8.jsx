...
export default function LandingPage({ setView }) {
  ...
  const features = [
    { title: 'Load Management', desc: 'Efficient dispatching, load status updates, rate calculations, and customer notifications in one place.', icon: '≡ƒôª' },
    { title: 'Dispatch Planning', desc: 'Smart routing, calendars, drag-and-drop assign tools, and driver schedules.', icon: '≡ƒôà' },
    { title: 'Driver App', desc: 'Offline support, turn-by-turn route navigation, status updates, and digital signature POD capture.', icon: '≡ƒô▒' },
    { title: 'GPS Tracking', desc: 'Live truck coordinates, breadcrumb path logs, custom geofences, and accurate ETA forecasting.', icon: '≡ƒôì' },
    { title: 'Warehouse Management', desc: 'Inventory counts, pick/pack sheets, bin allocations, and barcode scanning.', icon: '≡ƒÅó' },
    { title: 'Billing & Payroll', desc: 'Automated invoice runs, driver pay sheets, factoring exports, and ledger system integrations.', icon: '≡ƒÆ╡' },
    { title: 'Customer Portal', desc: 'Self-serve direct load booking, live tracking maps, and historical document archives.', icon: '≡ƒæÑ' },
    { title: 'AI Automation', desc: 'Smart dispatch matching systems, document character recognition (OCR), and load rate forecasts.', icon: '≡ƒñû' }
  ];
        ...
        <div className="bg-[#111827] h-full w-full rounded-lg p-4 font-mono text-[10px] text-slate-300 flex justify-center">
          <div className="w-48 bg-[#161F30] border-4 border-slate-700 rounded-2xl p-2.5 flex flex-col justify-between shadow-lg">
            <div className="text-center border-b border-[#23324C] pb-1 text-[8px]">
              <span className="text-emerald-400 font-extrabold">ΓùÅ LIVE CONNECTED</span>
            </div>
            <div className="my-2.5 space-y-1.5">
              ...
              <div className="bg-[#111827] p-2 rounded border border-[#23324C]">
                ...
                <div className="mt-1.5 text-[6px] text-brand-400 flex items-center">≡ƒôì 12 miles to destination</div>
              </div>
            </div>
              ...
              <div className="my-4 h-full flex flex-col justify-between">
                ...
                <div className="bg-[#0B0F19] border border-[#23324C] rounded-lg p-2.5 h-32 flex flex-col justify-between">
                  ...
                  <div className="flex justify-between text-[8px] text-slate-300">
                    <span>Houston TX Γ₧ö Atlanta GA</span><span>1,200 lbs</span><span className="text-emerald-400">ON TIME</span>
                  </div>
                  <div className="flex justify-between text-[8px] text-slate-300">
                    <span>Chicago IL Γ₧ö Dallas TX</span><span>42,000 lbs</span><span className="text-brand-400">TRANSIT</span>
                  </div>
                  <div className="flex justify-between text-[8px] text-slate-300">
                    <span>Seattle WA Γ₧ö Portland OR</span><span>8,500 lbs</span><span className="text-emerald-400">DELIVERED</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="border-y border-[#23324C]/50 bg-[#0B0F19] py-10 px-4">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 w-full lg:w-auto">
            ...
            <div className="text-center">
              <span className="block text-2xl sm:text-3xl font-black text-white">4.9/5 Γÿà</span>
