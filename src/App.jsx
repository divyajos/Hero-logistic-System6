...
function PublicLayout() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-darkbg text-[#F5F5F5] flex flex-col justify-between selection:bg-brand-500 selection:text-[#F5F5F5]">
      <Navbar />
      ...
      <LogisticsProvider>
        ...
        <Routes>
          ...
          <Route
            path="/customer"
            element={
              <ProtectedRoute allowedRoles={['Customer', 'Dispatcher']}>
                <CustomerLayout />
              </ProtectedRoute>
            }
          >
