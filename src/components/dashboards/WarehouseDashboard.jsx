                ...
                <div className="space-y-2 border-t border-slate-200 pt-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className="py-2 bg-slate-50 border border-slate-200 hover:bg-[#2E2E2E] text-slate-600 rounded-xl font-bold flex items-center justify-center gap-1.5 cursor-pointer text-[10px]"
                    >
