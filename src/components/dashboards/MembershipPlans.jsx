      ...
      <div className="glass rounded-2xl p-5 border border-slate-200 text-left space-y-4">
          ...
          <div className="space-y-4 text-slate-600">
            <div className="border border-slate-200 rounded-2xl overflow-hidden">
              <table className="min-w-full text-left border-collapse text-xs">
                ...
                <tbody className="divide-y divide-[#2E2E2E]/40 font-semibold">
                  {[
              ...
              <div className="lg:col-span-8 bg-white border border-slate-200 rounded-2xl p-4 space-y-4">
                ...
                <div className="h-60 w-full relative pt-4">
                  <svg className="w-full h-full" viewBox="0 0 500 200">
                    ...
                    {/* Grid Lines */}
                    <line x1="50" y1="30" x2="480" y2="30" stroke="#2E2E2E" strokeWidth="0.5" strokeDasharray="4 4" />
                    <line x1="50" y1="80" x2="480" y2="80" stroke="#2E2E2E" strokeWidth="0.5" strokeDasharray="4 4" />
                    <line x1="50" y1="130" x2="480" y2="130" stroke="#2E2E2E" strokeWidth="0.5" strokeDasharray="4 4" />
                    <line x1="50" y1="180" x2="480" y2="180" stroke="#2E2E2E" strokeWidth="1" />
                    ...
                    {/* Data dots */}
                    <circle cx="50" cy="140" r="4.5" fill="#0ea5e9" stroke="#0B0B0B" strokeWidth="1.5" />
                    <circle cx="190" cy="100" r="4.5" fill="#0ea5e9" stroke="#0B0B0B" strokeWidth="1.5" />
                    <circle cx="330" cy="60" r="4.5" fill="#0ea5e9" stroke="#0B0B0B" strokeWidth="1.5" />
                    <circle cx="470" cy="40" r="4.5" fill="#0ea5e9" stroke="#0B0B0B" strokeWidth="1.5" />
              ...
              <div className="lg:col-span-4 bg-white border border-slate-200 rounded-2xl p-4 flex flex-col justify-between">
                ...
                <div className="my-4 flex justify-center relative">
                  ...
                  <svg className="w-32 h-32" viewBox="0 0 100 100">
                    <circle cx="50" cy="50" r="40" fill="none" stroke="#2E2E2E" strokeWidth="12" />
        ...
        {activeSubTab === 'audits' && (
          <div className="space-y-4">
            ...
            <div className="border border-slate-200 rounded-2xl p-4 bg-slate-50/30 max-h-[380px] overflow-y-auto divide-y divide-[#2E2E2E]/35 text-xs text-left">
              {planAudits
