              ...
              <div className="h-[200px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={[
                    ...
                    <CartesianGrid strokeDasharray="3 3" stroke="#2E2E2E" opacity={0.2} />
                    <XAxis dataKey="month" stroke="#94a3b8" fontSize={9} />
                    <YAxis stroke="#94a3b8" fontSize={9} />
                    <Tooltip contentStyle={{ backgroundColor: '#1F1F1F', borderColor: '#2E2E2E', borderRadius: '12px', fontSize: '11px', color: '#fff' }} />
      ...
      {activeTab === 'scheduler' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch text-left">
          ...
          <div className="lg:col-span-7 glass rounded-2xl p-5 border border-slate-200 space-y-4">
            ...
            <div className="grid grid-cols-7 gap-1 sm:gap-2 text-center text-[10px] font-bold text-slate-500 border-b border-slate-200 pb-2">
              <span>SUN</span><span>MON</span><span>TUE</span><span>WED</span><span>THU</span><span>FRI</span><span>SAT</span>
            </div>
            <div className="grid grid-cols-7 gap-1 sm:gap-2 items-stretch">
            ...
            <div className="p-5 text-xs text-left">
              ...
              {selectedSubReport === 'Conversions' && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-[10px] text-center">
              ...
              {selectedSubReport === 'Revenue' && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-center text-[10px]">
                    <div className="bg-white/40 border border-slate-200/50 rounded-xl p-3">
                  ...
                  <div className="h-[160px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={stages.filter(s => !['Won','Lost'].includes(s)).map(s => ({
                        ...
                        <YAxis stroke="#94a3b8" fontSize={8} />
                        <Tooltip contentStyle={{ backgroundColor: '#1F1F1F', borderColor: '#2E2E2E', borderRadius: '12px', fontSize: '11px', color: '#fff' }} formatter={(v) => [`$${v.toLocaleString()}`, 'Pipeline $']} />
