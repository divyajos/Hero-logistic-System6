    ...
    <div className="hidden lg:flex" style={{
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 52 }}>
          <img src={heroLogo} alt="Hero Logistics Logo" style={{ height: 56, width: "auto", objectFit: "contain" }} className="hover:scale-105 transition-transform duration-300" />
          <div>
...
export default function AuthPages({ view }) {
  ...
  React.useEffect(() => {
    ...
    return () => {
      clearTimeout(timer);
      // Restore dashboard theme state when leaving auth pages
      if (wasLight) {
